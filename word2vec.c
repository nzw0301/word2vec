...
const int vocab_hash_size = 40000000;  // Maximum 40 * 0.7 = 28M words in the vocabulary
...
void TrainModel() {
  ...
  char prefix[MAX_STRING] = "context-";
  char *context_output_file = strcat(prefix, output_file);
